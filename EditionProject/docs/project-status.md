...
> **هدف این سند:** مرجع واحد برای برنامه‌نویس انسانی یا هوش مصنوعی تا بدون جست‌وجوی گسترده در کد، بداند **چه چیزی پیاده شده**، **چه چیزی نیمه‌کاره است**، **چه چیزی اصلاً وجود ندارد**، و **کجا باید ادامه کار داده شود**.
>
