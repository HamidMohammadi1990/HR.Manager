...
public interface IRedisCacheService
{
    ...
    Task<bool> SetAsync<T>(string key, T value, int duration, int dbIndex = 0, bool extend = false, CancellationToken token = default);
    ...
    /// <param name="token">Optional. The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
    /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
    Task<bool> SetAsync<T>(string key, T value, TimeSpan duration, int dbIndex = 0, bool extend = false, CancellationToken token = default);
    ...
    /// <param name="token">Optional. The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
    /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
    Task<bool> SetAsync<T>(string key, T value, DateTime duration, int dbIndex = 0, bool extend = false, CancellationToken token = default);
