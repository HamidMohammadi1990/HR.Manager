...
export const quickAccessActions = [
  ...
  {
    label: 'درخواست مرخصی یا ماموریت',
    description: 'ثبت درخواست جدید',
    path: '/leaves',
...
export function buildBreadcrumbs(path: string): BreadcrumbItem[] {
  const map: Record<string, string> = {
    ...
    '/leaves': 'مرخصی و ماموریت',
    '/leaves/inbox': 'کارتابل تأیید مرخصی و ماموریت',
...
export const pageMeta: Record<string, PageMeta> = {
  ...
  '/leaves': { title: 'مرخصی و ماموریت', description: 'درخواست، تأیید و پیگیری مرخصی و ماموریت پرسنل' },
  '/leaves/inbox': { title: 'کارتابل تأیید مرخصی و ماموریت', description: 'درخواست‌های در انتظار تأیید شما' },
