...
const FAQ_ITEMS = [
  {
    question: 'چطور مرخصی یا ماموریت ثبت کنم؟',
    answer:
      'از منوی پرسنل وارد بخش «مرخصی و ماموریت» شوید، روی «ثبت درخواست» کلیک کنید، نوع درخواست (مرخصی یا ماموریت) را انتخاب کرده و بازه زمانی را به‌صورت شمسی وارد کنید.',
    link: '/leaves',
  },
  {
