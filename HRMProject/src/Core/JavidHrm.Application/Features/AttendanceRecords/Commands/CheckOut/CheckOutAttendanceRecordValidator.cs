...
public class CheckOutAttendanceRecordValidator : AbstractValidator<CheckOutAttendanceRecordRequest>
{
    public CheckOutAttendanceRecordValidator(IEmployeeRepository employeeRepository)
    {
